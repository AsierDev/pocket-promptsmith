...
export default function NotFound() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-center gap-6 bg-slate-50 text-center">
      ...
      <p className="text-slate-500">Regresa a tu biblioteca de prompts para continuar.</p>
      <Link href="/prompts" className="rounded-full bg-primary px-6 py-2 text-white">
        Ir al dashboard
      </Link>
    </main>
  );
